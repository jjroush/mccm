...
```bash
# Apple Silicon
curl -L https://github.com/jjroush/mccm/releases/latest/download/mccm-v0.5.2-aarch64-apple-darwin.tar.gz | tar xz
sudo mv mccm /usr/local/bin/

# Intel Mac
curl -L https://github.com/jjroush/mccm/releases/latest/download/mccm-v0.5.2-x86_64-apple-darwin.tar.gz | tar xz
sudo mv mccm /usr/local/bin/
```
